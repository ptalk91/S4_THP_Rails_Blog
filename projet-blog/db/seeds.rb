...
10.times do
  User.create(first_name: Faker::Name.first_name,
    ...
    email: Faker::WebWebWeb.email)
end

# Creates 10 articles
10.times do
    Article.create(user_id: User.all.sample.id,
      title: Faker::QuoteLastWords.last_words,
      content: Faker::HouseOfCards.quote)
end

# Creates 5 categories
5.times do
  Category.create(name: Faker::DBZ.island)
end
